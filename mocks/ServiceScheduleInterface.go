...
// ServiceScheduleInterface is an autogenerated mock type for the ServiceScheduleInterface type
type ServiceScheduleInterface struct {
	mock.Mock
}

// CreateSchedule provides a mock function with given fields: _a0
func (_m *ServiceScheduleInterface) CreateSchedule(_a0 schedule.ScheduleDataEntity) (uint, error) {
	ret := _m.Called(_a0)
...
func (_m *ServiceScheduleInterface) DeleteSchedule(scheduleid uint) error {
...
func (_m *ServiceScheduleInterface) GetAllSchedule() ([]schedule.ScheduleDataEntity, error) {
	ret := _m.Called()
...
func (_m *ServiceScheduleInterface) GetScheduleById(scheduleid uint) (*schedule.ScheduleDataEntity, error) {
	ret := _m.Called(scheduleid)
...
func (_m *ServiceScheduleInterface) UpdateSchedule(scheduleid uint, account schedule.ScheduleDataEntity) error {
...
// NewServiceScheduleInterface creates a new instance of ServiceScheduleInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewServiceScheduleInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *ServiceScheduleInterface {
	mock := &ServiceScheduleInterface{}
	mock.Mock.Test(t)

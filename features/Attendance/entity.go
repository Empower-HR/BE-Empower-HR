...
type AServices interface {
	...
	GetAllAttbyDate(date int, limit int, offset int) ([]AttendanceDetail, error)
	...
	GetAllAttbyDateandPerson(date int ,limit int, offset int, personId uint) ([]AttendanceDetail, error)
	CheckingTheValueOfDate(date int) (error)
}
...
type AQuery interface {
	...
	GetTotalAttendancesCountbyDate(date int) (int64, error)
	GetTotalAttendancesCountbyDateandPerson(date int, personID uint) (int64, error)
	...
	GetAllAttbyDate(date int, limit int, offset int) ([]AttendanceDetail, error)
	GetAllAttbyDateandPerson(perseonID uint, date int, limit int, offset int) ([]AttendanceDetail, error)
